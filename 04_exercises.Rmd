...
When I change the zoom to the smaller number, such as 2. There is no terrain background whatsoever. I noticed the points were still showing, but the background was a brown gradient scheme. When I increased it to 5, a black blurry shape appeared, so the map was beginining to show up. When I increased the zoom number to 14, it never loaded.   
...
fav_places_by_Ashley <- tibble(
  place = c("Minneapolis Sculpture Garden", "The Nook", "Spitz", 
            "HCAO"),
  
  faves  = c("Yes", "Yes", "Yes", "No"), 
  
  long = c(-93.29272,-93.15782,-93.25371, -93.26810),
           
  lat = c(44.96776, 44.92603, 44.98846, 44.97522))
